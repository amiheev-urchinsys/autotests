...
from data.constants import DOMAIN_STAGE_URL, HUB_PAGE_VALUE_FIELDS_TITLE_TEXT
...
@pytest.mark.hubs
@pytest.mark.value_based
def test_create_single_type_field_with_searchable_checkbox_active_on_value_based_hub(context_and_playwright):
    """
    ...
    on_documents_insights_page.hubs_page.hub_page.add_data_points_button.click()
    on_documents_insights_page.hubs_page.hub_page.field_name_input.fill("single_field")
    ...
    on_documents_insights_page.hubs_page.hub_page.click_the_edit_button_on_the_field_label("single_field")
    # Verification
